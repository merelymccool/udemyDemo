...
<div class="form-group">Editing User ID <?php echo $adm_user_id ?></div>
    ...
    <div class="form-group">
        <label for="user-pass">Password</label>
            <input value="<?php echo $adm_user_pass; ?>" type="text" class="form-control" name="user-pass">
        </label>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="user-role">Role</label>
            <input value="<?php echo $adm_user_role; ?>" type="text" class="form-control" name="user-role">
        </label>
    </div>
    <div class="form-group">
        <label for="user-status">Status</label>
            <input value="<?php echo $adm_user_status; ?>" type="text" class="form-control" name="user-status">
        </label>
    </div>
    <div class="form-group">
